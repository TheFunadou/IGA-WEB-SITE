            ...
            <div className="bg-white rounded-lg p-5 ">
                ...
                <div className="flex mt-5">
                    <div className="w-1/4">
                        ...
                        <p className="font-bold text-2xl mt-5">Detalles de pago</p>
                        <div className="flex flex-col gap-2 mt-2">
                            <p className="text-lg font-bold">Medio de pago: <span className="font-normal">Mercado pago</span></p>
                            <p className="text-lg font-bold">Metodo de pago: <span className="font-normal">Tarjeta de credito</span></p>
                            <p className="text-lg font-bold">Estatus: <span className="font-normal">Aprobado</span></p>
                            <p className="text-lg font-bold">Detalle: <span className="font-normal">18x $291.66  ($5250.00)</span></p>
                        </div>
