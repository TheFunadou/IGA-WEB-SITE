    ...
    return (
        <div className="md:p-5">
            <div className="xl:flex">
                ...
                <section className="w-full xl:w-1/6">
                    {/* Section of pay */}
                    <div className="bg-white rounded-md p-5 flex flex-col gap-5">
                        ...
                        <div className="">
                            ...
                            <button className="underline text-blue-500 not-italic text-sm cursor-pointer" onClick={() => document.getElementById("my_modal_3").show()}><i className="bi bi-geo-alt"></i> Enviar a Coatzacoalcos, 96XXX</button>
                        </div>
                        {/* Quantity */}
                        <div className="mb-5">
                        ...
                        <div className="mt-5">
                            {/* Add to favorites */}
                            <button className="w-full text-center text-blue-500" onClick={handleAddToFavorites}>Agregar a favoritos <i className="bi bi-heart"></i></button>
                        </div>
                    </div>
                ...
                <dialog id="my_modal_3" className="modal">
                    <div className="modal-box">
                        ...
                        <p className="mt-5 underline font-bold text-blue-500 text-sm">Agregar o modificar direcciones de envio</p>
                    </div>
                </dialog>
            </div>
            <div className="mt-10">
